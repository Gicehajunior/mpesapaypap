...
class MpesaPay
{
	 ...
	 *******/
	public function lipa_bill_online($BusinessShortCode, $PartyA, $PartyB, $PhoneNumber, $Amount, $transactionId, $ConfirmationURL, $ValidationURL, $ProductName = null, $ShortCodeType = "paybill", $transaction_description = null,)
	{
